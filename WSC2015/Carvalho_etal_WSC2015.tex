...
an objective \todo{acho que objectividade não é adequado aqui, talvez um melhor 
adjetivo seja ``meaningful'', ou ``useful''} fashion, according to some 
...
subjectively\todo{Bayesianos não acham que subjetividade seja um problema. ;-)} 
...
\end{equation}\todo{faltou definir $t(\alpha)$}
...
diffusiveness\todo{talvez seja interessante discutir porque maximizar a 
entropia é desejável, neste contexto}, we propose to maximize the entropy of 
