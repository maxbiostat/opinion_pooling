...
\begin{tabular}{rrrrrrr}
  \hline
 & mean.prior & lower.prior & upper.prior & mean.post & lower.post & upper.post \\ 
  \hline
Equal weights & 0.90 & 0.64 & 1.00 & 0.90 & 0.73 & 0.99 \\ 
  maxEnt & 0.80 & 0.37 & 1.00 & 0.87 & 0.66 & 0.98 \\ 
  min KL div. & 0.82 & 0.42 & 1.00 & 0.87 & 0.67 & 0.99 \\ 
  Hier. prior & 0.88 & 0.53 & 1.00 & 0.90 & 0.71 & 0.99 \\ 
   \hline
\end{tabular}
\end{table}
...
\begin{table}[ht]
\caption{Weights obtained using the three methods for the proportion estimation problem. $^1$ -- Kullback-Liebler $^2$ -- Posterior mean }
\centering
\begin{tabular}{rrrrr}
  \hline
...
Minimum KL$^1$ divergence div. & 0.04 & 0.96 & 0.00 & 0.00 \\ 
