...
predictions_SIR
ggsave(plot = predictions_SIR, file = "../plots/SIR_bands.pdf")
...
alpha_post_plot
ggsave(plot = alpha_post_plot, filename = "../plots/posterior_alpha_SIR_example.pdf")
...
R0_posterior <- ggplot(data = R0.posteriors, aes(x = R0, colour = alpha, fill = alpha)) +
  ...
  theme_bw(base_size = 16)
R0_posterior
ggsave(plot = R0_posterior, file = "../plots/R0_posteriors_SIR_boardingSchool.pdf")
