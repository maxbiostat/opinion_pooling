...
\begin{figure}[!ht]
\begin{center}
\subfigure[][Expert priors]{\includegraphics[scale=.34]{../../plots/expert_densities_Savchuk.pdf}}
\subfigure[][Pooled priors]{\includegraphics[scale=.34]{../../plots/method_prior_densities_Savchuk.pdf}}
\end{center}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Posterior concentration}
 \begin{figure}[!ht]
\begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{But if tis' piecewise invertible...}
\begin{remark}
...
\begin{remark}[\textbf{BPS recovers LP in a toy example}]
Assume that 
\begin{itemize}
