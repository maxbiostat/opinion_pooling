...
In this section we introduce the necessary concepts and notation for the remainder of the paper.
DEFINE MSM, MELDING.
...
We now move on to study several approaches to assign weights.
We consider approaches based on optimality criteria and also study a full Bayesian solution that involves placing a hyperprior on the weights.
