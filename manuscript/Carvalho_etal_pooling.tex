...
\subsection*{Conjugate priors to the exponential family}%TODO: revise the phrasing 
...
Let $\mathbf{F}_{\theta}$ be a set of conjugate prior distributions representing the opinions of $K+1$ experts, and $f_i(\theta) = f(\theta | a_i, b_i)$ from equation (\ref{eq:priorEF}).
