...
\textbf{Normalisation~\cite{genest1986A}}. 
...
\section*{Combining distributions on a transformed quantity} % LM: more informative title, me thinks
...
\subsection*{Specifying a prior distribution on the weights}
